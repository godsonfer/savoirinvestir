'use client'
import { Loader, ShieldAlert, TriangleAlert } from "lucide-react";
...
const WorspaceIdPage = () => {
    ...
    }, [channelId, workspaceLoading, workspace, channelsLoading, router, workspaceId, open, setOpen, member, isAdmin, memberLoading])
    ...
    if (!workspace || !member) return (<div className='h-full flex flex-col  gap-2  items-center justify-center'>
