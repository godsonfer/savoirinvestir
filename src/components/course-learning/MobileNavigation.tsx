...
export const MobileNavigation = ({ 
  ...
  return (
    <>
      ...
      <div className="fixed top-0 left-0 right-0 h-14 bg-[#1a1b1a] border-b border-white/10 lg:hidden z-50">
      ...
      <div className="fixed bottom-0 left-0 right-0 h-16 bg-[#1a1b1a] border-t border-white/10 lg:hidden">
        <div className="flex h-full items-center justify-around">
          <Link href="/courses" className="flex flex-col items-center justify-center space-y-1">
            ...
            <span className="text-xs text-white">Cours</span>
          </Link>
          
          <Link href="/exercises" className="flex flex-col items-center justify-center space-y-1">
