        ...
        {isVisible && firstChapterId && (
            ...
            >
                <Link
                    ...
                    className="flex items-center gap-2 bg-gradient-to-r from-[#0097A7] to-[#D6620F] text-white px-6 py-3 rounded-full font-medium shadow-lg hover:shadow-xl transition-all duration-300"
                >
